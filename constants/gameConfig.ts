import { FoodDefinition, ComboTier, StabilityZone, MorningConditionConfig, PlotTwist, TimePhase, FoodEffects } from '@/types/game';
...
// Plot twist events (1-2 per game)
export const PLOT_TWISTS: PlotTwist[] = [
  ...
  {
    id: 'dehydration_warning',
    name: 'Dehydration Alert!',
    icon: '💧',
    description: 'Critical hydration needed!',
    duration: 8,
    effect: { hydration: -20 },
    bonusCondition: 'Water gives 3x points!',
    optimalActions: ['consume'],
  },
  {
    id: 'stressful_call',
    name: 'Stressful Call!',
    icon: '📞',
    description: 'Share comfort foods to destress!',
    duration: 8,
    effect: { stability: -15 },
    ongoingEffect: { stability: -1 },
    bonusCondition: 'Share comfort foods for 2x points!',
  ...
  },
  {
    ...
    name: 'Social Lunch!',
    icon: '🎉',
    description: 'Sharing is caring - bonus for sharing!',
    duration: 10,
    effect: {},
    bonusCondition: 'All shared foods give 3x points!',
    optimalActions: ['share'],
    shareBonus: true,
  },
  {
    ...
    icon: '😴',
    description: 'Energy crashing - save carbs for later!',
    duration: 8,
    effect: { energy: -20 },
    ongoingEffect: { energy: -2 },
    bonusCondition: 'Caffeine UP, heavy carbs LEFT!',
    optimalActions: ['consume', 'save'],
  },
  {
    id: 'temptation_wave',
    name: 'Temptation Wave!',
    icon: '🍰',
    description: 'Sugar invasion! Banish them all!',
    duration: 6,
    effect: {},
    bonusCondition: 'Banish all sugars for 3x points!',
  ...
  },
  {
    ...
    name: 'Health Check!',
    icon: '🏥',
    description: 'Stay balanced for bonus!',
    duration: 5,
    effect: {},
    bonusCondition: 'Maintain balance for 5x multiplier!',
    optimalActions: ['consume', 'reject'],
  },
];
